...
% % plot 24h tracks of whales
% plot(positionx_41(1,:),positiony_41(1,:))
% plot(positionx_41,positiony_41)
% plot(positionx_20(1,:),positiony_20(1,:))
% plot(positionx_20,positiony_20)
% plot(positionx_10(1,:),positiony_10(1,:))
% plot(positionx_10,positiony_10)
...
% print -dtiffnocompression vanderHoop_Figure1_revised2d.tif
% 
